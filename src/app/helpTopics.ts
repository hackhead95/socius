...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  { anchor: 'ai-help-optional', title: 'AI help (optional)', chapter: 'AI help', keywords: ['ai', 'gemini', 'assistant'] },
  { anchor: 'set-it-up', title: 'Set up AI help', chapter: 'AI help', keywords: ['ai', 'gemini', 'api key'] },
  { anchor: 'before-you-send-anything', title: 'Before you send anything to an AI', chapter: 'AI help', keywords: ['ai', 'privacy', 'anonymise', 'ethics'] },
