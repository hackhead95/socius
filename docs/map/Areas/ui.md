...
## Files
- [[Icon.tsx]]: Small stroke icons (16px grid, currentColor). Kept deliberately plain.
- [[MeasureIcon.tsx]]: Measurement-level glyphs, drawn in SVG like SPSS's ruler / bars / circles, plus one for text.
- [[Menu.tsx]]: Keyboard-accessible menus: used by the menubar dropdowns, the narrow-screen menu sheet and right-click context menus.
- [[Modal.tsx]]
