...
> Shared test helpers for the AI provider layer: an in-memory localStorage and fetch responses.
- Used in: [[features.test.ts]], [[ai-diagnose.test.ts]], [[ai-local.test.ts]], [[ai.test.ts]], [[webllm.test.ts]]

### jsonResponse
*function* · line 24 · exported
- Used in: [[ai-tools.test.ts]], [[ai-http.test.ts]], [[ai-local.test.ts]], [[ai.test.ts]], [[gemini-fixtures.ts]]
