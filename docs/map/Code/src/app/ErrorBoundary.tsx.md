...
*Module* · area [[Areas/app|app]] · 162 lines
...
## Private helpers
componentStack() (line 16) · VIEW_NAMES (line 102) · tell() (line 128)
...
### CrashScreen
*component* · line 70 · exported · note: [[CrashScreen|<CrashScreen>]]
> ---------- the whole app ----------
...
### AppErrorBoundary
*component* · line 96 · exported · note: [[AppErrorBoundary|<AppErrorBoundary>]]
...
### PanelBoundary
*component* · line 104 · exported · note: [[PanelBoundary|<PanelBoundary>]]
...
### GuardedDialogs
*component* · line 137 · exported · note: [[GuardedDialogs|<GuardedDialogs>]]
...
### QuietBoundary
*component* · line 155 · exported · note: [[QuietBoundary|<QuietBoundary>]]
