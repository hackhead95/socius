...
*Module* · area [[lib - stats|lib/stats]] · 288 lines
...
## Types
CumulativeFit (line 17) · OrdinalGoodnessOfFit (line 235)
...
- Calls: [[logistic.ts#collapsePatterns|collapsePatterns()]], [[logistic.ts#columnScales|columnScales()]], [[logistic.ts#divergenceTracker|divergenceTracker()]], [[logistic.ts#unstableParams|unstableParams()]], [[matrix.ts#spdInverseRobust|spdInverseRobust()]], [[matrix.ts#spdSolveRobust|spdSolveRobust()]], [[matrix.ts#zeros|zeros()]], [[ordinal.ts]]
