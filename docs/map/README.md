...
| `calls` | Calls / Called by | 5574 |
| `calls-action` | Calls store actions / Called by | 405 |
| `checks` | Checks error code / Checked by | 79 |
| `configured-in` | Configured in dialog / Configures | 48 |
| `contains` | Defines / Defined in | 1833 |
...
| `generates-syntax` | Generates SPSS syntax / Generated by | 77 |
| `handles` | Handles / Handled by | 61 |
| `has-action` | Actions / Store | 60 |
| `has-key` | State keys / Store | 73 |
