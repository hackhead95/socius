...
- [[varUtils.ts#optionInactive|optionInactive()]]
...
## Calls store actions
- [[addOutput()|useStore.addOutput()]] · selector

## Rendered by
- [[ProcedureDialog|<ProcedureDialog>]]

## Binds shortcut
- [[Alt+ArrowDown (DialogBody)]]
- [[Alt+ArrowUp (DialogBody)]]
- [[ArrowDown (DialogBody)]]
- [[ArrowUp (DialogBody)]]
- [[Backspace (DialogBody)]]
- [[Delete (DialogBody)]]
- [[Enter (DialogBody)]]
- [[Mod+Enter (DialogBody)]]
- [[Space (DialogBody)]]
